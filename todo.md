...
подумать над кэшом в браузере на картинки
каталог
разрешить пустые сообщения с вложениями !
Проверить отправку сообщений почтой и добавить аутентификацию с отправлением письма НА почту айтичана !
добавить публичную борду!
Сделать красивую вёрстку !
add interface check to every interface